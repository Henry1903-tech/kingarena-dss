...
## Trang web hướng dẫn (1 trang)

File: `site/index.html`

- Đây là landing page mô tả quy trình GitHub → Streamlit Cloud → Gemini Secrets
- Tập trung vào **AI chatbox** và **biểu đồ tự động**
- Có chỗ đặt “ảnh chụp màn hình” theo từng bước để đưa vào Word

### Cập nhật link thật cho 2 nút trên landing page

Sửa file `site/config.js`:

- `streamlitAppUrl`: link app Streamlit Cloud của bạn
- `githubRepoUrl`: link repo GitHub của bạn
